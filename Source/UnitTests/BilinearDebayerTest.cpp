...
static std::shared_ptr<BilinearDebayer> debayer;
...
inline void SetupTest()
{
    ...
    debayer = std::make_shared<BilinearDebayer>(*outputImage);
}

TEST_CASE("Bilinear Test BGGR", "[OC::Image]")
{
...
TEST_CASE("Bilinear Test GBRG", "[OC::Image]")
{
    unsigned int dataLength = 64;
...
TEST_CASE("Bilinear Test GRBG", "[OC::Image]")
{
    unsigned int dataLength = 64;
