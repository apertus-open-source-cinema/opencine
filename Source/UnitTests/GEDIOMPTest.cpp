...
static std::shared_ptr<GEDIDebayerOMP> debayer;
...
inline void SetupTest()
{
    ...
    debayer = std::make_shared<GEDIDebayerOMP>(*outputImage);
}

TEST_CASE("GEDI OMP Test BGGR", "[OC::Image]")
{
...
TEST_CASE("GEDI OMP Test GBRG", "[OC::Image]")
{
    unsigned int dataLength = 64;
...
TEST_CASE("GEDI OMP Test GRBG", "[OC::Image]")
{
    unsigned int dataLength = 64;
