...
static std::shared_ptr<SHOODAKDebayerOMP> debayer;
...
inline void SetupTest()
{
    ...
    debayer = std::make_shared<SHOODAKDebayerOMP>(*outputImage);
}

TEST_CASE("SHOODAK OMP Test BGGR", "[OC::Image]")
{
...
TEST_CASE("SHOODAK OMP Test GBRG", "[OC::Image]")
{
    unsigned int dataLength = 64;
...
TEST_CASE("SHOODAK OMP Test GRBG", "[OC::Image]")
{
    unsigned int dataLength = 64;
...
TEST_CASE("SHOODAK OMP Test RGGB", "[OC::Image]")
{
    unsigned int dataLength = 64;
