...
static std::shared_ptr<SHOODAKDebayer> debayer;
...
inline void SetupTest()
{
    ...
    debayer = std::make_shared<SHOODAKDebayer>(*outputImage);
}
...
TEST_CASE("SHOODAK Test GBRG", "[OC::Image]")
{
    unsigned int dataLength = 64;
...
TEST_CASE("SHOODAK Test GRBG", "[OC::Image]")
{
    unsigned int dataLength = 64;
...
TEST_CASE("SHOODAK Test RGGB", "[OC::Image]")
{
    unsigned int dataLength = 64;
