...
void OCBackupLayout::SetupDriveView()
{
...
void OCBackupLayout::SetupFolderView()
{
    int i = 0;
}

void OCBackupLayout::DriveListChanged(std::vector<std::string> driveList)
{
...
void OCBackupLayout::SelectDrive(const QModelIndex& current, const QModelIndex& previous)
{
