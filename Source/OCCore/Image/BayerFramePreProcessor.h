...
void BayerFramePreProcessor::ExtractOddRows()
{
...
void BayerFramePreProcessor::ExtractEvenRows()
{
...
void BayerFramePreProcessor::Convert12To16Bit()
{
    int j = 0;
    int dataSize = (int)(_size * 1.5f); //16bit / 12bit
